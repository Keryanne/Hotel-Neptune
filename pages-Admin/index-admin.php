...
<div style="text-align:center; background-color:white; padding-top:20px; padding-bottom:20px; ">
    <h2>Vous êtes connecté en mode administrateur</h2>
    <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor" class="bi bi-diagram-3" viewBox="0 0 16 16">
